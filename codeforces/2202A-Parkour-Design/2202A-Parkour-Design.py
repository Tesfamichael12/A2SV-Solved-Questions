import sys, math; from collections import defaultdict, Counter, deque; from bisect import bisect_left, bisect_right; from random import randint; from itertools import accumulate
